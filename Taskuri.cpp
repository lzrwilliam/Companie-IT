...
Task::Task(string Denumire, float Valoare, int zi, int luna, int an) : DenumireTask(std::move(Denumire)),
                                                                       ValoareTask(Valoare) {
...
TaskRetelistica::TaskRetelistica(string Denumire, float Valoare, int zi, int luna, int an, int NrEchipinMentenanta,
                                 int NrReteleimplicate) : Task(std::move(Denumire), Valoare, zi, luna, an),
